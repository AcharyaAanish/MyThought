    ...
    <div id="content">
        <div class="row">
            <div class="container-fluid">
                <form action="{{route('take.update',$takeme->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group" id="form-box">
                                        <input type="text" class="form-control"  id="product_name" name="product_name" style="outline: none;" value="{{old('product_name',$takeme->product_name)}}"  required/>
                                    </div>
                                </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <input type="text" class="form-control"  id="product_cost" name="product_cost" style="outline: none;" value="{{old('product_cost',$takeme->product_cost)}}" required/>
                                </div>
                            </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="product_discount" name="product_discount" style="outline: none;" value="{{old('product_discount',$takeme->product_discount)}}"/>
                            </div>
                        </div>
                </div>
                           <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <div class="input-image">
                                        ...
                                        --}}
                                        <input type="file" name="image_takeme" id="image_takeme"  class="form-control" />
                                    </div>
                                </div>
                            </div>
                       </div>
