            ...
            <div class="container-fluid">
                <form action="{{route('movie.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group" id="form-box">
                                        <input type="text" class="form-control"  id="title_movies" name="title_movies" style="outline: none;" required/>
                                    </div>
                                </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <input type="text" class="form-control"  id="director_name" name="director_name" style="outline: none;" required/>
                                </div>
                            </div>
                    </div><div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="cast_name" name="cast_name" style="outline: none;" required/>
                            </div>
                        </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <input type="text" class="form-control"  id="rating_movies" name="rating_movies" style="outline: none;" required/>
                                </div>
                            </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="type_movies" name="type_movies" style="outline: none;" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="release_date" name="release_date" style="outline: none;" required/>
                            </div>
                        </div>
                </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description_movies" rows="5" name="description_movies"></textarea>
                        </div>
                   </div>
                     <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <div class="input-image">
                                        ...
                                        --}}
                                        <input type="file" name="image_movies" id="image_movies"  class="form-control" required/>
                                    </div>
                                </div>
                            </div>
                     </div>
                       <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="author_name" name="author_name" style="outline: none;" required/>
                            </div>
                        </div>
                    </div>
