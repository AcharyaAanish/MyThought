    ...
    <!-- Main Content -->
        <div class="row ">
            <div class="col-md-12">
                <div class="card" >
                    <div class="card-header" >
                        ...
                        {{-- <div class="card-button">
                            <a href="{{route('user.create')}}" class="btn btn-colors">{{__('Add Data')}}</a>
                        </div> --}}
                ...
                <div class="d-flex flex-wrap justify-content-center">{{$users->links()}}</div>
...
<div class="modal fade" id="exampleModalCenter{{$userkey}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="text-field">
                    ...
                    <h6> Subject:<span>{{$user->subject}} </span></h6>
                    <h6> Message:</h6>
