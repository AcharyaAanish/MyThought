                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-button">
                                <a href="{{route('blog.index')}}" class="btn btn-colors">Back To Index</a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group" id="form-box">
                                        <input type="text" class="form-control"  id="title_blog" name="title_blog" style="outline: none;" value="{{old('title_blog',$blogs->title_blog)}}"/>
                                    </div>
                                </div>
                        </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description_blog" rows="5" name="description_blog">{{$blogs->description_blog}}</textarea>
                        </div>
                   </div>
                     <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="auhtor_name" name="author_name" style="outline: none;" value="{{old('author_name',$blogs->author_name)}}"/>
                            </div>
                        </div>
                    </div>
