                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group" id="form-box">
                                        <input type="text" class="form-control"  id="title_blog" name="title_blog" style="outline: none;" required/>
                                    </div>
                                </div>
                        </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description_blog" rows="5" name="description_blog"></textarea>
                        </div>
                   </div>
                     <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <div class="input-image">
                                        ...
                                        --}}
                                        <input type="file" name="image_blog" id="image_blog"  class="form-control" required/>
                                    </div>
                                </div>
                            </div>
                     </div>
                       <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="auhtor_name" name="author_name" style="outline: none;" required/>
                            </div>
                        </div>
                    </div>
