                ...
                <div class="card" >
                    <div class="card-header" >
                        ...
                        <div class="card-button">
                            <a href="{{route('blog.create')}}" class="btn btn-colors">{{__('Add Data')}}</a>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <img src={{asset("/storage/$blog->image_blog")}} width="150" style="height: 100px ! important; object-fit:fill;" rel="nofollow" alt="Image not found">
                                              </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('blog.edit',$blog->id)}}" class="btn btn-update">
...
<div class="modal fade" id="exampleModalCenter{{$blogkey}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="text-field">
                    ...
                    <span>{!! $blog->description_blog !!} </span>
                </div>
        </div>
