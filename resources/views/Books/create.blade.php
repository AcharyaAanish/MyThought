                ...
                <form action="{{route('book.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group" id="form-box">
                                        <input type="text" class="form-control"  id="title_books" name="title_books" style="outline: none;" required/>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <input type="text" class="form-control"  id="rating_books" name="rating_books" style="outline: none;" required/>
                                </div>
                            </div>
                    </div>
                     <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <input type="text" class="form-control"  id="type_books" name="type_books" style="outline: none;" required/>
                                </div>
                            </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="publish_date" name="publish_date" style="outline: none;" required/>
                            </div>
                        </div>
                </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description_books" rows="5" name="description_books"></textarea>
                        </div>
                   </div>
                     <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <div class="input-image">
                                        ...
                                        --}}
                                        <input type="file" name="image_books" id="image_books"  class="form-control" required/>
                                    </div>
                                </div>
                            </div>
                     </div>
                       <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group" id="form-box">
                                <input type="text" class="form-control"  id="writer_name" name="writer_name" style="outline: none;" required/>
                            </div>
                        </div>
                    </div>
