        ...
        <div class="row">
            <div class="container-fluid">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group" id="form-box">
                                    <div class="input-image">
                                        ...
                                        --}}
                                        <input type="file" name="image_about" id="image_about"  class="form-control" required/>
                                    </div>
                                </div>
                            </div>
                       </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description_about" rows="5" name="description_about"></textarea>
                    </div>
               </div>
